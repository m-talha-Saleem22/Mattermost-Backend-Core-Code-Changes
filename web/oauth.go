...
func deauthorizeOAuthApp(c *Context, w http.ResponseWriter, r *http.Request) {
	fmt.Println("************************ deauthorizeOAuthApp  *****************************")
...
func completeOAuth(c *Context, w http.ResponseWriter, r *http.Request) {
	fmt.Println("************************ completeOAuth  web/oauthgo *****************************")
...
func loginWithOAuth(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	// fmt.Println("____loginHint: ", loginHint)
	// fmt.Println("____redirectURL: ", redirectURL)
	...
	//fmt.Println("____ teamId: ", teamId)
	...
	// props["action"] = model.OAuthActionLogin
	// props["team_id"] = teamId
	// props["redirect_to"] = redirectURL

	// cookieValue := model.NewId()
	// email := ""
	// action := props["action"]
	// tokenExtra := email + action + cookieValue

	// stateToken, _ := c.App.CreateOAuthStateToken(tokenExtra)
	// fmt.Println("_______ stateToken: ", stateToken)
	// props[model.UserAuthServiceIsMobile] = strconv.FormatBool(false)
	// props["token"] = stateToken.Token
	// state := b64.StdEncoding.EncodeToString([]byte(model.MapToJSON(props)))

	// /////////statteeeeeeeeeeee
	// // endPoint := "https://accounts.google.com/o/oauth2/v2/auth"                             // sso.AuthEnndpoint
	// // clientId := "228239028945-p2gsdjd08brhbhp3ofetj3j838ac3gp6.apps.googleusercontent.com" // sso.Id
	// // endPoint := "https://gitlab.com/oauth/authorize"
	// // clientId := "0da4fe452b0b97c288b7f6cc1729a92916d668929a66d2730c789e8f910a134a"
	// // scope := "read_user"
	...
	// redirectURI := /*c.App.GetSiteURL()*/ "http://localhost:8065" + "/signup/" + c.Params.Service + "/complete"
	// fmt.Println("_______redirectURI: ", redirectURI)
	...
	// fmt.Println("_______ stateToken: ", stateToken)
	// fmt.Println("_______ authURL: ", authURL)
