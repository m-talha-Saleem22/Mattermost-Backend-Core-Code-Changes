...
func CheckClientCompatibility(agentString string) bool {
	fmt.Println("################################ CheckClientCompatibility ################################")
